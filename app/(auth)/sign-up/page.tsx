      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12 bg-white overflow-y-auto relative">
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full bg-primary-800 hover:bg-primary-900 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary-900/20 transition-all hover:-translate-y-1 flex items-center justify-center gap-2">
